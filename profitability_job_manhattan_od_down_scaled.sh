...
python main_a2c_multi_agent.py --mode 2 --max_episodes 40032 --actor_clip 3 --critic_clip 3 --use_od_prices --q_lr 1e-4 --p_lr 1e-4 --city "nyc_manhattan" --checkpoint_path profitability_manhattan_mode2_40k_dual_agent_od_down_scaled --loss_aversion 2.0
