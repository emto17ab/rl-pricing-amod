...
python main_a2c.py --reward_scalar 10000 --critic_warmup_episodes 50 --mode ${MODE} --city "washington_dc" --q_lr 0.001 --p_lr 0.0005 --actor_clip 5 --critic_clip 1000 --max_episodes 1000000 --use_od_prices --checkpoint_path single_agent_washington_dc_mode${MODE}