...
python main_a2c_multi_agent.py --reward_scalar 2000 --critic_warmup_episodes 50 --mode $MODE --city "nyc_man_south" --q_lr 0.0003 --p_lr 0.0003 --actor_clip 1000 --critic_clip 1000 --max_episodes 85000 --use_od_prices --agent0_vehicle_ratio $RATIO --checkpoint_path dual_agent_nyc_man_south_vehicle_split_ratio${RATIO}_mode${MODE}
